                    ...
                    <div className="">
                      <div className="flex flex-row justify-around items-center">
                        ...
                        <button
                          ...
                          className="flex-1 min-w-10 max-w-40 h-10 px-3 py-2 border bg-[#727272] border-gray-300 text-white hover:bg-gray-700 transition-colors text-sm"
                        >
