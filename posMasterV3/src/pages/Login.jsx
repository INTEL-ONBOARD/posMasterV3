...
function Login() {
  ...
  <div className="w-[296px] mx-auto space-y-6">
    {/* Email */}
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full h-[38px] pl-10 pr-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400"
      ...
      {isLoading ? (
        ...
        'Login'
          ...
          <div className="mt-8 text-center">
            ...
            <button className="text-blue-700 hover:text-blue-800 text-sm font-medium hover:underline transition-colors">
