...
/**
 * Get the current SQLite schema version (Fix 14 — schema version matching)
 * Alias for getCurrentVersion, exposed with a descriptive name for use in sync services.
 * @param {Database} db - The better-sqlite3 database instance
 * @returns {number} The highest applied migration version (0 if none)
 */
